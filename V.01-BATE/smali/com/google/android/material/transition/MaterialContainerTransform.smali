...
.method private static captureValues(Landroidx/transition/x;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
    .locals 2
    .param p0    # Landroidx/transition/x;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p1    # Landroid/view/View;
    ...
    iget-object p2, p0, Landroidx/transition/x;->b:Landroid/view/View;
...
.method public captureEndValues(Landroidx/transition/x;)V
    ...
    invoke-static {p1, v0, v1, v2}, Lcom/google/android/material/transition/MaterialContainerTransform;->captureValues(Landroidx/transition/x;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/x;Landroidx/transition/x;)Landroid/animation/Animator;
    ...
    :cond_1
    iget-object v3, v1, Landroidx/transition/x;->a:Ljava/util/Map;
    ...
    :cond_2
    iget-object v4, v0, Landroidx/transition/x;->b:Landroid/view/View;

    iget-object v5, v1, Landroidx/transition/x;->b:Landroid/view/View;
