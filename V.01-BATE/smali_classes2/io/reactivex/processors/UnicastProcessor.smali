...
# virtual methods
.method checkTerminated(ZZZLc/a/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Lc/a/c;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_2
    invoke-interface {p4}, Lc/a/c;->onComplete()V
...
.method drain()V
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lc/a/c;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lc/a/c;)V
...
.method drainFused(Lc/a/c;)V
    ...
    :cond_2
    invoke-interface {p1, v4}, Lc/a/c;->onNext(Ljava/lang/Object;)V
...
.method drainRegular(Lc/a/c;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLc/a/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-interface {v5, v8}, Lc/a/c;->onNext(Ljava/lang/Object;)V
